...
Deadline: **Tuesday, July 21, 2026 at 5:00 PM Pacific Time** — Wednesday, July 22 at
**02:00 CEST (Europe/Zurich)**.

## Product

- [x] New working project built during the event
- [x] Clear category: Work and productivity
- [x] Setup and sample-data instructions
- [x] Judges can test the core flow without an account, API key, or rebuild
...
- [ ] Record a public or unlisted YouTube video under three minutes
- [ ] Audio explains both Codex and GPT-5.6 use
- [ ] Core product is shown working, not represented by mockups
- [ ] Open video URL in a private window and play it end to end
- [ ] Keep private repository paths, browser history, tokens, and unrelated projects off-screen
